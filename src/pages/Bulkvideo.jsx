  ...
  return (
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="flex justify-center space-x-4 mt-6">
        <button className="border-2 border-blue-900 px-6 py-2 rounded font-bold">Cancel</button>
        <button onClick={()=>navigate("/generate-bulk-videos")} className="bg-[#000050] text-white px-4 py-2 rounded font-bold">Finish Importing</button>
      </div>
...
export default BulkDoctorVideo;
